...
def init():
	...
	runtime = api.metaffi_runtime.MetaFFIRuntime('go')
...
class TestSanity(unittest.TestCase):
	...
	def test_div_integers(self):
		params_type = [api.metaffi_types.new_metaffi_type_with_alias(api.metaffi_types.MetaFFITypes.metaffi_int64_type),
						api.metaffi_types.new_metaffi_type_with_alias(api.metaffi_types.MetaFFITypes.metaffi_int64_type)]
	...
	def test_wait_a_bit(self):
		ret_type = [api.metaffi_types.new_metaffi_type_with_alias(api.metaffi_types.MetaFFITypes.metaffi_int64_type)]
